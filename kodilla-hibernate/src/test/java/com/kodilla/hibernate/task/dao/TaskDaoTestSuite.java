...
class TaskDaoTestSuite {
    ...
    @Autowired
    private static final String TODO = "Test: Study Hibernate";
    @Autowired
    ...
    void testNamedQueries() {
        ...
        List<Task> durationLongerThanTasks = taskDao.findByDurationGreaterThan(6);

        //Then
        try {
            assertEquals(149, longTasks.size());
